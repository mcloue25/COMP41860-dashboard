    ...
    () => [
      ...
      },
      {
        ...
        items: [
          ...
          {
            label: "Registration",
            href: "/students/studentdesk/registration/",
            target: "_self",
          },
  ...
  return (
    ...
    >
        ...
        <nav className="ml-auto hidden items-center gap-1 lg:flex">
            ...
            {/* --- NEW: Buttons on the SAME ROW as nav items --- */}
        ...
        {/* Mobile panel (unchanged except layout) */}
        {mobileOpen && (
        <div className="border-t border-slate-200 bg-white lg:hidden">
            ...
            {/* Buttons in mobile stay stacked */}
